    ...
    <section class="game-options fade-in">
        <div class="option">
            ...
            <div class="join-btnDiv">
                ...
                <svg class="topright" width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="option">
            ...
            <div class="join-btnDiv">
                <input type="text" class="join-btn" placeholder="ENTER THE CODE" name="code">
                <svg class="topright topright2" width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
